	...
	namespace client {
		...
		void Corpse::AddToScene() {
			...
			Vector3 tX, tY;
			{
				...
				//Chameleon
				Vector3 fixDim = MakeVector3(8, 4, 9);
			...
			// draw Head
			{
				...
				//Chameleon
				Vector3 fixDim = MakeVector3(5, 5, 5);
				Vector3 ModelDim = MakeVector3(model->GetDimensions());
				Vector3 scale = fixDim / ModelDim;
				ModelRenderParam paramTMP = param;
				paramTMP.matrix *= Matrix4::Scale(scale);
			...
			// draw Arms
			{
				...
				model = (teamId == 0) ?
					renderer->RegisterModel("Models/PlayerA/Arm.kv6"):
					renderer->RegisterModel("Models/PlayerB/Arm.kv6");
				...
				//Chameleon
				Vector3 fixDim = MakeVector3(3, 3, 12);
				Vector3 ModelDim = MakeVector3(model->GetDimensions());
				Vector3 scale = fixDim / ModelDim;
				ModelRenderParam paramTMP = param;
				paramTMP.matrix *= Matrix4::Scale(scale);
