 ...
 */
 ...
 namespace spades {
	...
	IToolSkin, IThirdPersonToolSkin, IBlockSkin {
		...
		ThirdPersonBlockSkinA(Renderer@ r, AudioDevice@ dev) {
			@renderer = r;
			@audioDevice = dev;
			@model = renderer.RegisterModel
				("Models/Weapons/BlockA/Block3rd.kv6");
		}
	...
	IBlockSkin@ CreateThirdPersonBlockSkinA(Renderer@ r, AudioDevice@ dev) {
		return ThirdPersonBlockSkinA(r, dev);
	}
}
