 ...
 */
 ...
 namespace spades {
	...
	IToolSkin, IThirdPersonToolSkin, IGrenadeSkin {
		...
		ThirdPersonGrenadeSkinB(Renderer@ r, AudioDevice@ dev) {
			@renderer = r;
			@audioDevice = dev;
			@model = renderer.RegisterModel
				("Models/Weapons/GrenadeB/Grenade3rd.kv6");
		}
	...
	IGrenadeSkin@ CreateThirdPersonGrenadeSkinB(Renderer@ r, AudioDevice@ dev) {
		return ThirdPersonGrenadeSkinB(r, dev);
	}
}
