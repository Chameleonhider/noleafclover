 ...
 */
 ...
 namespace spades {
	...
	IToolSkin, IThirdPersonToolSkin, ISpadeSkin {
		...
		ThirdPersonSpadeSkinA(Renderer@ r, AudioDevice@ dev) {
			@renderer = r;
			@audioDevice = dev;
	...
	ISpadeSkin@ CreateThirdPersonSpadeSkinA(Renderer@ r, AudioDevice@ dev) {
		return ThirdPersonSpadeSkinA(r, dev);
	}
}
